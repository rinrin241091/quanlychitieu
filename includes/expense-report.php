...
nw.document.write('<html><head><title>Chi tieu Bao cao - ' + currentDate + '</title></head><body>');
    ...
    <div class="col-md-12">
      ...
      <div class="card">
        <div class="card-header">
          <div class="row">
            <div class="col-md-6">
              <h4 class="card-title">Chi tieu Bao cao</h4>
            </div>
        ...
        <div class="card-body" id="printable">
          <h5 align="center" style="color:blue">Datewise <?php echo ucfirst($rtype); ?> Bao cao from <span style="color:red"><?php echo $fdate ?></span> to <span style="color:red"><?php echo $tdate ?></span></h5>
          <hr />
          <?php
          $userid=$_SESSION['detsuid'];
          $ret=mysqli_query($db,"SELECT Chi tieuDate,category,Description,NoteDate,SUM(Chi tieuCost) as totaldaily FROM `tblexpense`  where (Chi tieuDate BETWEEN '$fdate' and '$tdate') && (UserId='$userid') group by Chi tieuDate, category");
          ...
          <table id="datatable" class="table table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
            ...
            <tbody>
              ...
              <tr>
                <td><?php echo $cnt;?></td>
                <td><?php  echo $row['Chi tieuDate'];?></td>
