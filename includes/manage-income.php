...
function loadThu nhap() {
    ...
    $.ajax({
        ...
        type: 'GET',
        data: { page: currentPage, limit: currentLimit, type: 'income' },
        dataType: 'json',
        ...
        error: function(xhr) {
            if (xhr.status === 401) {
                ...
                $('#income-tbody').html('<tr><td colspan="6" class="text-center text-danger">Error loading data</td></tr>');
            }
        }
    });
}
...
$(document).ready(function() {
    ...
    $('#search-input').on('keyup', function() {
        ...
        $('#income-tbody tr').filter(function() {
