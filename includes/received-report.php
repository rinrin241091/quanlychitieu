...
nw.document.write('<html><head><title>Received Bao cao - ' + currentDate + '</title></head><body>');
    ...
    <div class="col-md-12">
      ...
      <div class="card">
        <div class="card-header">
          <div class="row">
            <div class="col-md-6">
              <h4 class="card-title">Received Bao cao</h4>
            </div>
        ...
        <div class="card-body" id="printable">
          <h5 align="center" style="color:blue">Received <?php echo ucfirst($rtype); ?> Bao cao from <span style="color:red"><?php echo $fdate ?></span> to <span style="color:red"><?php echo $tdate ?></span></h5>
          <hr />
          <?php
          $userid=$_SESSION['detsuid'];
          $ret=mysqli_query($db,"SELECT name,date_of_cho vay,status,description,SUM(amount) as totaldaily FROM `cho vay`  where (date_of_cho vay BETWEEN '$fdate' and '$tdate') && (UserId='$userid') && (status = 'received') group by date_of_cho vay");
